...
def apkGenerator(yaml_path, aId):
    ...
    if(package_name != "com.bhargo.user"):
        ...
        subprocess.call(f"xcopy {working_dir}\\{repo_name}\\app\\src\\androidTest\\java\\com\\bhargo\\user\\* {working_dir}\\{repo_name}\\app\\src\\androidTest\\java\\{newPath}\\* /s /e /i /Y", cwd=f"{working_dir}\\{repo_name}\\app\\src\\androidTest\\java\\com\\bhargo\\user", shell=True)

        subprocess.call(f"rmdir /Q /S {working_dir}\\{repo_name}\\app\\src\\androidTest\\java\\com\\bhargo\\user", shell=True)

        subprocess.call(f"mkdir {newPath}", cwd=f"{working_dir}\\{repo_name}\\app\\src\\main\\java", shell=True)

        subprocess.call(f"xcopy {working_dir}\\{repo_name}\\app\\src\\main\\java\\com\\bhargo\\user\\* {working_dir}\\{repo_name}\\app\\src\\main\\java\\{newPath}\\* /s /e /i /Y", cwd=f"{working_dir}\\{repo_name}\\app\\src\\main\\java\\com\\bhargo\\user", shell=True)

        subprocess.call(f"rmdir /Q /S {working_dir}\\{repo_name}\\app\\src\\main\\java\\com\\bhargo\\user", shell=True)

        subprocess.call(f"mkdir {newPath}", cwd=f"{working_dir}\\{repo_name}\\app\\src\\test\\java", shell=True)

        subprocess.call(f"xcopy {working_dir}\\{repo_name}\\app\\src\\test\\java\\com\\bhargo\\user\\* {working_dir}\\{repo_name}\\app\\src\\test\\java\\{newPath}\\* /s /e /i /Y", cwd=f"{working_dir}\\{repo_name}\\app\\src\\test\\java\\com\\bhargo\\user", shell=True)

        subprocess.call(f"rmdir /Q /S {working_dir}\\{repo_name}\\app\\src\\test\\java\\com\\bhargo\\user", shell=True)
    ...
    subprocess.call(f"{working_dir}/{repo_name}/sh gradlew clean assembleDebug", cwd=f"{working_dir}/{repo_name}/", shell=True)
